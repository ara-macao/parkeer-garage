...
public class MVCMain {
    ...
    public MVCMain() {
        ...
        JFrame graphLineFrame = windowBuilder(settings.getGraphLineControllerName(), Color.GRAY, settings.getGraphLineControllerDimensions() , settings.getGraphLineControllerPosition());
